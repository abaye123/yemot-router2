                ...
                if (ops.uncaughtErrorsHandler) {
                    ...
                    try {
                        ...
                        if (err instanceof ExitError) {
                            console.log(`👋 the call was exited from the extension /${call.extension} in uncaughtErrorsHandler` + (error.context ? ` (by ${error.context?.caller} to ${error.context?.target})` : ''));
                        } else {
