...
const { HangupError, TimeoutError, ExitError, CallError } = require('./errors');
...
class Call {
    ...
    */
    id_list_message (messages, options = {}) {
        ...
        const messagesCombined = makeMessagesData(messages, { removeInvalidChars: options.removeInvalidChars ?? this.#defaults.id_list_message.removeInvalidChars }, this);
